...
[React](https://reactjs.org/) je knihovna pro tvorbu uživatelského rozhranní. Hlavní myšlenkou je rozdělení uživatelského rozhranní na komponenty, které se skládají z menších částí do větších celků. V Reactu je komponenta definovaná jako ryzí funkce. Ta představuje transformaci dat na view.

Syntaxí React velmi připomíná HTML, takže je velmi snadné (pro kohokoliv se základy tvorby webových aplikací) se v něm začít velmi rychle orientovat.
