...
7. Možnosti (a limity) prohlížečů, transpilery do ES5 (Typescript, ClojureScript), Server-side vs Client-side rendering
8. React (funkcionální komponenty a jejich kompozice, hooky, routování)
9. Imutabilní datové struktury (Immutable.js), state management (Redux)
10. Dokončení klientské aplikace (React + TypeScript), využívající vytvořené API
